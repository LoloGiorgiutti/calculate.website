...
(function () {
  ...
  var DESCS = {
    '/bmi': {
      en: 'Body Mass Index (BMI) is a widely used screening tool that estimates body fat based on height and weight. Calculated by dividing weight in kilograms by height in meters squared, it helps classify individuals as underweight, normal weight, overweight, or obese according to WHO guidelines. While BMI doesn\'t directly measure body fat or distinguish muscle from fat, it provides a useful starting point for assessing weight-related health risks at a population level. Adults with a BMI between 18.5 and 24.9 are considered to be in the healthy range. For a more complete picture, pair BMI with body fat percentage and waist circumference measurements.',
      es: 'El Índice de Masa Corporal (IMC) es una herramienta de diagnóstico que estima la grasa corporal a partir de la altura y el peso. Se calcula dividiendo el peso en kilogramos por el cuadrado de la altura en metros y clasifica a las personas en bajo peso, peso normal, sobrepeso u obesidad según los criterios de la OMS. El IMC no distingue entre músculo y grasa, pero es un punto de partida práctico para evaluar riesgos de salud. El rango saludable para adultos es entre 18,5 y 24,9. Complementalo con la calculadora de grasa corporal y el perímetro de cintura para una evaluación más completa.',
      pt: 'O Índice de Massa Corporal (IMC) é uma ferramenta de triagem que estima a gordura corporal com base na altura e no peso. Calculado dividindo o peso em quilogramas pelo quadrado da altura em metros, classifica pessoas em abaixo do peso, peso normal, sobrepeso ou obesidade segundo os critérios da OMS. Embora o IMC não distinga músculo de gordura, é um ponto de partida prático para avaliar riscos de saúde. A faixa saudável para adultos está entre 18,5 e 24,9. Complete com a calculadora de gordura corporal e a circunferência da cintura para uma avaliação mais abrangente.',
      fr: 'L\'Indice de Masse Corporelle (IMC) est un outil de dépistage qui estime la masse grasse à partir de la taille et du poids. Calculé en divisant le poids en kilogrammes par le carré de la taille en mètres, il classe les individus en insuffisance pondérale, poids normal, surpoids ou obésité selon les critères de l\'OMS. Bien qu\'il ne distingue pas la masse musculaire de la masse grasse, c\'est un point de départ pratique pour évaluer les risques de santé. La plage saine pour les adultes est entre 18,5 et 24,9. Complétez avec le calcul du pourcentage de masse grasse pour une évaluation plus complète.',
    },
    '/bmr': {
      en: 'Your Basal Metabolic Rate (BMR) is the number of calories your body burns at complete rest to sustain vital functions — breathing, circulation, cell repair, and temperature regulation. It represents 60–75% of your total daily calorie burn. This calculator uses the Mifflin-St Jeor formula, the most accurate for the general population. Multiplying your BMR by an activity factor gives your Total Daily Energy Expenditure (TDEE) — the actual number of calories you need each day. To lose weight, eat below your TDEE; to gain muscle, eat above it. Even a 300–500 kcal daily deficit produces sustainable fat loss of 0.3–0.5 kg per week.',
      es: 'La Tasa Metabólica Basal (TMB) es la cantidad de calorías que tu cuerpo quema en reposo completo para mantener funciones vitales: respiración, circulación, reparación celular y regulación de temperatura. Representa entre el 60 y el 75% del gasto calórico total diario. Esta calculadora usa la fórmula Mifflin-St Jeor, la más precisa para la población general. Al multiplicar la TMB por un factor de actividad se obtiene el Gasto Energético Total Diario (TDEE), que es la cantidad real de calorías que necesitás por día. Para bajar de peso, comé por debajo del TDEE; para ganar músculo, por encima. Un déficit de 300–500 kcal diarios genera una pérdida sostenida de 0,3–0,5 kg por semana.',
      pt: 'A Taxa Metabólica Basal (TMB) é a quantidade de calorias que seu corpo queima em repouso completo para manter funções vitais: respiração, circulação, reparo celular e regulação de temperatura. Ela representa 60–75% do gasto calórico total diário. Esta calculadora usa a fórmula Mifflin-St Jeor, a mais precisa para a população em geral. Multiplicando a TMB por um fator de atividade obtém-se o Gasto Energético Total Diário (TDEE), a quantidade real de calorias necessárias por dia. Para emagrecer, consuma abaixo do TDEE; para ganhar músculo, acima. Um déficit de 300–500 kcal por dia produz perda sustentável de 0,3–0,5 kg por semana.',
      fr: 'Votre Métabolisme de Base (MB) est le nombre de calories que votre corps brûle au repos complet pour maintenir les fonctions vitales : respiration, circulation, réparation cellulaire et régulation thermique. Il représente 60–75% de votre dépense calorique totale quotidienne. Cette calculatrice utilise la formule Mifflin-St Jeor, la plus précise pour la population générale. En multipliant le MB par un facteur d\'activité, on obtient la Dépense Énergétique Totale Journalière (DETJ) — les calories réellement nécessaires chaque jour. Pour perdre du poids, mangez en dessous du DETJ ; pour prendre du muscle, au-dessus. Un déficit de 300–500 kcal par jour produit une perte de graisse durable de 0,3–0,5 kg par semaine.',
    },
    '/mortgage': {
      en: 'A mortgage is a long-term loan used to purchase real estate, where the property itself serves as collateral. This calculator uses the standard French amortization method, where each monthly payment is fixed and covers both interest and principal. In the early years, most of your payment goes toward interest; over time, more goes toward reducing the principal balance. The total interest paid over the life of a mortgage can equal or exceed the original loan amount, which is why making extra payments early has a significant impact. Use the amortization schedule below to see exactly how your balance decreases month by month.',
      es: 'Una hipoteca es un préstamo a largo plazo para adquirir una propiedad, que actúa como garantía del crédito. Esta calculadora usa el sistema francés de amortización, donde la cuota mensual es fija y cubre tanto intereses como capital. En los primeros años, la mayor parte de la cuota va a intereses; con el tiempo, más va a reducir el capital. El total de intereses pagados a lo largo de una hipoteca puede igualar o superar el monto original del préstamo, por eso hacer pagos adicionales al inicio tiene un impacto significativo. Usá el cronograma de amortización para ver exactamente cómo disminuye tu saldo mes a mes.',
      pt: 'Um financiamento imobiliário é um empréstimo de longo prazo para adquirir um imóvel, que serve como garantia do crédito. Esta calculadora usa o sistema de amortização francês (Price), onde a parcela mensal é fixa e cobre juros e amortização do principal. Nos primeiros anos, a maior parte da parcela vai para juros; com o tempo, mais vai para reduzir o saldo devedor. O total de juros pagos ao longo do financiamento pode igualar ou superar o valor original do empréstimo, por isso fazer pagamentos extras no início tem impacto significativo. Use a tabela de amortização para ver exatamente como o saldo diminui mês a mês.',
      fr: 'Un crédit immobilier est un prêt à long terme pour l\'achat d\'un bien, qui sert de garantie. Cette calculatrice utilise le système d\'amortissement français, où la mensualité est fixe et couvre à la fois les intérêts et le capital. Dans les premières années, la majeure partie de la mensualité va aux intérêts ; progressivement, une plus grande part rembourse le capital. Le total des intérêts payés sur la durée du crédit peut égaler ou dépasser le montant initial emprunté, d\'où l\'intérêt de faire des remboursements anticipés. Consultez le tableau d\'amortissement pour voir précisément comment votre solde diminue mois après mois.',
    },
    '/compound-interest': {
      en: 'Compound interest is often called the eighth wonder of the world — and for good reason. Unlike simple interest, which is calculated only on the principal, compound interest earns returns on both the principal and the accumulated interest. This creates an exponential growth curve that becomes more powerful the longer it runs. The key variables are: initial principal, interest rate, compounding frequency (monthly compounds faster than annually), and time. A 7% annual return doubles your investment in roughly 10 years (Rule of 72: divide 72 by the rate). Starting early matters enormously — investing 10 years earlier can double your final wealth, even with smaller contributions.',
      es: 'El interés compuesto es a menudo llamado la octava maravilla del mundo, y con razón. A diferencia del interés simple, que solo se calcula sobre el capital inicial, el interés compuesto genera rendimientos sobre el capital y los intereses acumulados. Esto crea una curva de crecimiento exponencial que se vuelve más poderosa cuanto más tiempo transcurre. Las variables clave son: capital inicial, tasa de interés, frecuencia de capitalización (mensual capitaliza más rápido que anual) y el tiempo. A una tasa anual del 7%, tu capital se duplica en aproximadamente 10 años (Regla del 72: dividí 72 por la tasa). Empezar temprano es fundamental: invertir 10 años antes puede duplicar el patrimonio final.',
      pt: 'Os juros compostos são frequentemente chamados de a oitava maravilha do mundo, e com razão. Ao contrário dos juros simples, calculados apenas sobre o capital inicial, os juros compostos rendem sobre o capital e os juros acumulados. Isso cria uma curva de crescimento exponencial que se torna mais poderosa com o tempo. As variáveis-chave são: capital inicial, taxa de juros, frequência de capitalização (mensal capitaliza mais rápido que anual) e tempo. A uma taxa anual de 7%, seu capital dobra em aproximadamente 10 anos (Regra dos 72: divida 72 pela taxa). Começar cedo é fundamental: investir 10 anos antes pode dobrar o patrimônio final.',
      fr: 'Les intérêts composés sont souvent appelés la huitième merveille du monde, et pour cause. Contrairement aux intérêts simples, calculés uniquement sur le capital initial, les intérêts composés génèrent des rendements sur le capital et les intérêts accumulés. Cela crée une courbe de croissance exponentielle qui devient plus puissante avec le temps. Les variables clés sont : capital initial, taux d\'intérêt, fréquence de capitalisation (mensuelle capitalise plus vite qu\'annuelle) et durée. À un taux annuel de 7%, votre capital double en environ 10 ans (Règle des 72 : divisez 72 par le taux). Commencer tôt est décisif : investir 10 ans plus tôt peut doubler votre patrimoine final.',
    },
    '/percentage': {
      en: 'Percentages are fundamental to everyday math — from discounts and taxes to statistics and finance. This calculator handles the four most common percentage operations in one place: finding X% of Y, calculating what percentage X is of Y, computing percentage change between two values, and finding the original value before a percentage increase or decrease. The key formula to remember: percentage = (part ÷ whole) × 100. Percentage change is always calculated relative to the original value, not the new one. Understanding the difference between percentage points and percentages is also crucial — an interest rate rising from 3% to 5% is a 2 percentage point increase, but a 66.7% increase in the rate itself.',
      es: 'Los porcentajes son fundamentales en las matemáticas cotidianas: desde descuentos e impuestos hasta estadísticas y finanzas. Esta calculadora maneja las cuatro operaciones más comunes en un solo lugar: encontrar el X% de Y, calcular qué porcentaje es X de Y, calcular la variación porcentual entre dos valores, y encontrar el valor original antes de un aumento o disminución porcentual. La fórmula clave: porcentaje = (parte ÷ total) × 100. La variación porcentual siempre se calcula respecto al valor original, no al nuevo. También es importante distinguir entre puntos porcentuales y porcentajes: una tasa que sube del 3% al 5% es un aumento de 2 puntos porcentuales, pero un aumento del 66,7% en la tasa en sí.',
      pt: 'As porcentagens são fundamentais na matemática do dia a dia — de descontos e impostos a estatísticas e finanças. Esta calculadora resolve as quatro operações mais comuns em um só lugar: encontrar X% de Y, calcular qual porcentagem X é de Y, calcular a variação percentual entre dois valores e encontrar o valor original antes de um aumento ou redução percentual. A fórmula principal: porcentagem = (parte ÷ total) × 100. A variação percentual é sempre calculada em relação ao valor original, não ao novo. Também é importante distinguir pontos percentuais de porcentagem: uma taxa que sobe de 3% para 5% é um aumento de 2 pontos percentuais, mas um aumento de 66,7% na própria taxa.',
      fr: 'Les pourcentages sont fondamentaux dans les mathématiques du quotidien — des remises et taxes aux statistiques et finances. Cette calculatrice gère les quatre opérations les plus courantes en un seul endroit : trouver X% de Y, calculer quel pourcentage X représente de Y, calculer la variation en pourcentage entre deux valeurs, et retrouver la valeur originale avant une hausse ou baisse en pourcentage. La formule clé : pourcentage = (partie ÷ total) × 100. La variation en pourcentage se calcule toujours par rapport à la valeur d\'origine. Il est aussi crucial de distinguer points de pourcentage et pourcentages : un taux passant de 3% à 5% représente une hausse de 2 points de pourcentage, mais une hausse de 66,7% du taux lui-même.',
    },
    '/age': {
      en: 'An exact age calculation goes beyond simply subtracting birth year from the current year. This calculator accounts for whether your birthday has occurred yet in the current year, the different lengths of each month, and leap years — giving you your precise age in years, months, and days. It also shows useful derived statistics: your age in total days, weeks, hours, and the day of the week you were born. Exact age calculations are important for legal purposes (eligibility for benefits, voting, retirement), medical contexts (pediatric dosing, developmental milestones), and insurance calculations. Enter any past date to calculate the age of a historical event or person.',
      es: 'Un cálculo de edad exacto va más allá de simplemente restar el año de nacimiento del año actual. Esta calculadora tiene en cuenta si tu cumpleaños ya ocurrió en el año en curso, los diferentes largos de cada mes y los años bisiestos, dando tu edad precisa en años, meses y días. También muestra estadísticas derivadas: tu edad en días totales, semanas, horas y el día de la semana en que naciste. Los cálculos exactos de edad son importantes para fines legales (elegibilidad para beneficios, voto, jubilación), contextos médicos (dosificación pediátrica, hitos del desarrollo) y cálculos de seguros. Ingresá cualquier fecha pasada para calcular la edad de un evento histórico o persona.',
      pt: 'Um cálculo de idade exato vai além de simplesmente subtrair o ano de nascimento do ano atual. Esta calculadora considera se seu aniversário já ocorreu no ano corrente, os diferentes comprimentos de cada mês e os anos bissextos, fornecendo sua idade precisa em anos, meses e dias. Também mostra estatísticas derivadas: sua idade em dias totais, semanas, horas e o dia da semana em que você nasceu. Cálculos exatos de idade são importantes para fins legais (elegibilidade para benefícios, voto, aposentadoria), contextos médicos (dosagem pediátrica, marcos de desenvolvimento) e cálculos de seguros. Insira qualquer data passada para calcular a idade de um evento histórico ou pessoa.',
      fr: 'Un calcul d\'âge exact va bien au-delà de la simple soustraction de l\'année de naissance de l\'année actuelle. Cette calculatrice tient compte de si votre anniversaire a déjà eu lieu dans l\'année en cours, des durées différentes de chaque mois et des années bissextiles, vous donnant votre âge précis en années, mois et jours. Elle affiche aussi des statistiques dérivées : votre âge en jours, semaines, heures et le jour de la semaine de votre naissance. Les calculs d\'âge exacts sont importants pour des raisons légales (éligibilité aux prestations, vote, retraite), médicales (dosage pédiatrique, jalons de développement) et pour les calculs d\'assurance. Saisissez n\'importe quelle date passée pour calculer l\'âge d\'un événement historique.',
    },
    '/geometry': {
      en: 'This geometry calculator uses a bidirectional solver — meaning you can enter any known property of a shape and all other properties are calculated instantly. For a square, knowing just the area is enough to find the side, perimeter, and diagonal. For a circle, knowing the circumference gives you the radius, diameter, and area. Two-variable shapes like rectangles and cylinders need any two independent measurements to solve. The calculator supports 8 fundamental shapes: Square, Circle, Equilateral Triangle, Rectangle, Cube, Sphere, Square Pyramid, and Cylinder — covering the most common 2D and 3D geometry problems in school, construction, and engineering.',
      es: 'Esta calculadora de geometría usa un solver bidireccional: podés ingresar cualquier propiedad conocida de una figura y todas las demás se calculan al instante. Para un cuadrado, conocer solo el área es suficiente para encontrar el lado, perímetro y diagonal. Para un círculo, conocer la circunferencia da radio, diámetro y área. Las figuras con dos variables libres, como el rectángulo y el cilindro, necesitan dos medidas independientes para resolverse. La calculadora soporta 8 figuras fundamentales: Cuadrado, Círculo, Triángulo Equilátero, Rectángulo, Cubo, Esfera, Pirámide cuadrangular y Cilindro, cubriendo los problemas de geometría 2D y 3D más comunes en la escuela, la construcción y la ingeniería.',
      pt: 'Esta calculadora de geometria usa um solver bidirecional: você pode inserir qualquer propriedade conhecida de uma figura e todas as demais são calculadas instantaneamente. Para um quadrado, conhecer apenas a área é suficiente para encontrar o lado, perímetro e diagonal. Para um círculo, conhecer a circunferência fornece raio, diâmetro e área. Figuras com dois graus de liberdade, como retângulo e cilindro, precisam de dois valores independentes para serem resolvidas. A calculadora suporta 8 figuras fundamentais: Quadrado, Círculo, Triângulo Equilátero, Retângulo, Cubo, Esfera, Pirâmide de base quadrada e Cilindro — cobrindo os problemas de geometria 2D e 3D mais comuns na escola, construção e engenharia.',
      fr: 'Cette calculatrice de géométrie utilise un solveur bidirectionnel : entrez n\'importe quelle propriété connue d\'une figure et toutes les autres sont calculées instantanément. Pour un carré, connaître uniquement l\'aire suffit à trouver le côté, le périmètre et la diagonale. Pour un cercle, connaître la circonférence donne le rayon, le diamètre et l\'aire. Les figures à deux degrés de liberté, comme le rectangle et le cylindre, nécessitent deux mesures indépendantes. La calculatrice supporte 8 figures fondamentales : Carré, Cercle, Triangle Équilatéral, Rectangle, Cube, Sphère, Pyramide à base carrée et Cylindre — couvrant les problèmes de géométrie 2D et 3D les plus courants à l\'école, en construction et en ingénierie.',
    },
    '/word-counter': {
      en: 'Word and character counts are essential for writers, students, and content creators who need to meet specific length requirements. Social media platforms have strict limits: Twitter/X allows 280 characters, Instagram captions can reach 2,200, and LinkedIn posts perform best under 700 words. For SEO, meta descriptions should be 155–160 characters, and title tags 50–60 characters. Academic essays often specify word counts ranging from 250 to 10,000 words depending on the assignment. This tool also calculates reading time based on the average reading speed of 200 words per minute — useful for estimating how long blog posts, articles, or presentations will take to consume.',
      es: 'Los conteos de palabras y caracteres son esenciales para escritores, estudiantes y creadores de contenido que necesitan cumplir requisitos de extensión específicos. Las redes sociales tienen límites estrictos: Twitter/X permite 280 caracteres, las descripciones de Instagram pueden llegar a 2.200, y las publicaciones de LinkedIn funcionan mejor con menos de 700 palabras. Para SEO, las meta descripciones deben tener 155–160 caracteres y los títulos 50–60. Los ensayos académicos suelen especificar conteos de palabras que van de 250 a 10.000 según el trabajo. Esta herramienta también calcula el tiempo de lectura basado en la velocidad promedio de 200 palabras por minuto, útil para estimar cuánto tardará en leerse un artículo, post o presentación.',
      pt: 'Contagens de palavras e caracteres são essenciais para escritores, estudantes e criadores de conteúdo que precisam atender a requisitos de extensão específicos. As redes sociais têm limites rígidos: Twitter/X permite 280 caracteres, legendas do Instagram podem chegar a 2.200, e posts do LinkedIn têm melhor desempenho com menos de 700 palavras. Para SEO, meta descrições devem ter 155–160 caracteres e títulos 50–60. Redações acadêmicas geralmente especificam contagens de palavras de 250 a 10.000, dependendo do trabalho. Esta ferramenta também calcula o tempo de leitura com base na velocidade média de 200 palavras por minuto — útil para estimar quanto tempo um artigo, post ou apresentação levará para ser lido.',
      fr: 'Les comptages de mots et de caractères sont essentiels pour les écrivains, étudiants et créateurs de contenu qui doivent respecter des exigences de longueur spécifiques. Les réseaux sociaux ont des limites strictes : Twitter/X autorise 280 caractères, les légendes Instagram peuvent atteindre 2 200, et les posts LinkedIn performent mieux sous 700 mots. Pour le SEO, les méta-descriptions doivent faire 155–160 caractères et les titres 50–60. Les dissertations académiques spécifient souvent des comptes de mots allant de 250 à 10 000 selon le devoir. Cet outil calcule aussi le temps de lecture basé sur la vitesse moyenne de 200 mots par minute — utile pour estimer combien de temps prendra un article, un post ou une présentation.',
    },
    '/weighted-average': {
      en: 'A weighted average is used whenever different values don\'t contribute equally to the final result. In academic grading, a final exam worth 60% of your grade matters more than a quiz worth 5%. In finance, portfolio returns are weighted by each asset\'s proportion of the total. This calculator supports any grading scale — 0–10 (common in Europe and Latin America), 0–100 (US percentage system), or 0–20 (French system). Simply enter each subject or component with its grade and weight, and the weighted average is computed in real time. You can add as many subjects as needed. The color coding (green/amber/red) shows at a glance whether your result is above or below typical passing thresholds.',
      es: 'Un promedio ponderado se usa cuando distintos valores no contribuyen por igual al resultado final. En calificaciones académicas, un examen final que vale el 60% de la nota importa más que un ejercicio del 5%. En finanzas, los rendimientos de un portafolio se ponderan por la proporción de cada activo. Esta calculadora soporta cualquier escala de calificación: 0–10 (común en Europa y LATAM), 0–100 (sistema de porcentajes de EE. UU.) o 0–20 (sistema francés). Ingresá cada materia con su nota y su peso, y el promedio ponderado se calcula en tiempo real. Podés agregar tantas materias como necesites. El código de color (verde/ámbar/rojo) muestra de un vistazo si el resultado está por encima o por debajo del umbral típico de aprobación.',
      pt: 'Uma média ponderada é usada quando diferentes valores não contribuem igualmente para o resultado final. Em avaliações acadêmicas, uma prova final que vale 60% da nota importa mais do que um exercício de 5%. Em finanças, os retornos de uma carteira são ponderados pela proporção de cada ativo. Esta calculadora suporta qualquer escala de notas: 0–10 (comum na Europa e LATAM), 0–100 (sistema de porcentagem dos EUA) ou 0–20 (sistema francês). Insira cada disciplina com sua nota e peso, e a média ponderada é calculada em tempo real. Você pode adicionar quantas disciplinas precisar. O código de cores (verde/âmbar/vermelho) mostra de imediato se o resultado está acima ou abaixo do limiar típico de aprovação.',
      fr: 'Une moyenne pondérée est utilisée lorsque différentes valeurs ne contribuent pas également au résultat final. En notation académique, un examen final valant 60% de la note compte plus qu\'un devoir valant 5%. En finance, les rendements d\'un portefeuille sont pondérés par la proportion de chaque actif. Cette calculatrice supporte toutes les échelles de notation : 0–20 (système français), 0–10 (Europe et Amérique latine), ou 0–100 (système américain). Saisissez chaque matière avec sa note et son coefficient, et la moyenne pondérée est calculée en temps réel. Vous pouvez ajouter autant de matières que nécessaire. Le code couleur (vert/orange/rouge) indique d\'un coup d\'œil si le résultat est au-dessus ou en dessous du seuil de réussite habituel.',
    },
    '/lcm': {
      en: 'The Least Common Multiple (LCM) and Greatest Common Divisor (GCD) are fundamental concepts in number theory with practical everyday applications. The LCM is essential for adding fractions with different denominators — you need a common denominator, and the LCM gives you the smallest one. The GCD (also called HCF or GCF) is used to simplify fractions to their lowest terms. Both can be found using prime factorization: decompose each number into prime factors, then for LCM take the highest power of each prime, and for GCD take the lowest. This calculator supports up to 10 numbers simultaneously and shows the complete prime factorization for each, making it ideal for homework, exam preparation, and teaching.',
      es: 'El Mínimo Común Múltiplo (MCM) y el Máximo Común Divisor (MCD) son conceptos fundamentales de la teoría de números con aplicaciones prácticas cotidianas. El MCM es esencial para sumar fracciones con distinto denominador: se necesita un denominador común, y el MCM da el más pequeño posible. El MCD se usa para simplificar fracciones a su mínima expresión. Ambos se pueden encontrar mediante factorización prima: se descompone cada número en factores primos, luego para el MCM se toma el mayor exponente de cada primo, y para el MCD el menor. Esta calculadora admite hasta 10 números simultáneamente y muestra la factorización prima completa de cada uno, ideal para tareas, preparación de exámenes y enseñanza.',
      pt: 'O Mínimo Múltiplo Comum (MMC) e o Máximo Divisor Comum (MDC) são conceitos fundamentais da teoria dos números com aplicações práticas cotidianas. O MMC é essencial para somar frações com denominadores diferentes — é necessário um denominador comum, e o MMC fornece o menor possível. O MDC é usado para simplificar frações à mínima expressão. Ambos podem ser encontrados pela fatoração em primos: decompõe-se cada número em fatores primos, depois para o MMC toma-se o maior expoente de cada primo, e para o MDC o menor. Esta calculadora suporta até 10 números simultaneamente e mostra a fatoração prima completa de cada um — ideal para tarefas, preparação para provas e ensino.',
      fr: 'Le Plus Petit Commun Multiple (PPCM) et le Plus Grand Commun Diviseur (PGCD) sont des concepts fondamentaux de la théorie des nombres avec des applications pratiques quotidiennes. Le PPCM est indispensable pour additionner des fractions de dénominateurs différents — il faut un dénominateur commun, et le PPCM donne le plus petit possible. Le PGCD est utilisé pour simplifier les fractions à leur forme irréductible. Les deux se trouvent par décomposition en facteurs premiers : décomposez chaque nombre, puis pour le PPCM prenez la plus haute puissance de chaque prime, et pour le PGCD la plus basse. Cette calculatrice supporte jusqu\'à 10 nombres simultanément et affiche la décomposition complète de chacun — idéale pour les devoirs, la préparation aux examens et l\'enseignement.',
    },
  };
  ...
  var css = [
    ...
    '.calc-desc-block{max-width:720px;margin:0 auto;padding:0 20px 28px;font-size:14px;color:var(--ink-2);line-height:1.8}',
    '.calc-desc-block p{margin-bottom:12px}.calc-desc-block p:last-child{margin-bottom:0}',
    'html[data-theme="dark"] .calc-desc-block{color:var(--ink-2)}',
  ...
  (function(){
    ...
    var enPath = path.replace(/^\/(es|pt|fr)(\/|$)/, '/').replace(/\/$/, '') || '/';
    var faqs = FAQS[path];
    var descData = DESCS[enPath];
    var descText = descData ? (descData[CW_LANG] || descData.en) : null;
    if((!faqs || !faqs.length) && !descText) return;

    var descHtml = descText ? '<div class="calc-desc-block"><p>' + descText + '</p></div>' : '';
    ...
    var faqHtml = '';
    if(faqs && faqs.length) {
      faqHtml = '<div class="faq-section"><div class="faq-heading">Frequently asked questions</div>';
      faqs.forEach(function(f){
        if(!f.q || !f.a) return;
        faqHtml += '<details class="faq-item" open><summary>' + f.q + '</summary>'
              + '<div class="faq-a">' + f.a + '</div></details>';
      });
      faqHtml += '</div>';
    }

    var html = descHtml + faqHtml;
